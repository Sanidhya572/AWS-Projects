# ⚡ APIs with AWS Lambda + API Gateway  
...
### 🔑 What You’ll Learn  
- 🖥️ Create and configure AWS **Lambda functions**  
- 🔗 Connect Lambda functions to **API Gateway**  
- 📡 Define API **resources and methods** (e.g., `/users` with GET)  
- 🚀 Deploy your API to a **public endpoint**  
- 🧩 Understand how this forms the **Logic Tier** in a 3-tier solution  
